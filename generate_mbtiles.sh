...
# --drop-ways drops objects regardless --keep-ways
osmfilter data/out.o5m \
  --ignore-dependencies \
  --drop-ways="mtb:scale= route=mtb" \
  --keep-ways="highway=cycleway or ( bicycle=yes and highway=footway ) or ( highway!=proposed and highway!=construction and bicycle=designated ) or ( highway!=proposed and highway!=construction and cycleway=track ) or ( highway!=proposed and highway!=construction and cycleway:*=track ) or ( highway!=proposed and highway!=construction and cycleway=lane ) or ( highway!=proposed and highway!=construction and cycleway:*=lane )" \
  >data/out.osm
